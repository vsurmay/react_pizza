...
import { deleteAllBasketProducst } from "../../redux/slices/basketSlice";
        ...
        <>
          <div className={classes.top}>
            ...
            <button
              ...
              onClick={() => dispatch(deleteAllBasketProducst())}
            >
              <p className={classes.clearText}>Очистити корзину</p>
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
          ...
          <div className={classes.main}>
            {basketItems.map((product) => (
              <BasketItem key={product.uniqueId} item={product} />
            ))}
          </div>
          <div className={classes.bottom}>
            <p className={classes.count}>
              Всього піцц: <span>{totalQuantity} шт.</span>
            </p>
            <p className={classes.totalPrice}>
              Сума зaмовлення: <span>{totalPrice} ₴</span>
            </p>
          </div>
